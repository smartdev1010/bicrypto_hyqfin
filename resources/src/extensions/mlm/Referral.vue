    ...
    <div>
        <div class="grid gap-5 xs:grid-cols-1 md:grid-cols-4">
            <div class="col-span-1">
                <div class="card card-profile">
                    <div class="card-body">
                        ...
                        <div
                            class="mt-1"
                            v-if="mlmStore.bvWithdrawable != null"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <button
                                        class="btn btn-outline-success mt-5 w-full"
            ...
            <div class="col-span-3">
                <div class="mb-5 grid gap-5 xs:grid-cols-1 md:grid-cols-2">
                    <div>
                        <div
                            class="mb-5 grid gap-5 xs:grid-cols-1 md:grid-cols-2"
                            :key="mlmStore.bvWithdrawable"
                        >
                                ...
                                <div class="card-body">
                                    ...
                                    >
                                        <div class="avatar-content">
                                            <i
                                                class="bi bi-briefcase font-medium"
                                            ></i>
                                        </div>
                                    </div>
                            ...
                            >
                                <div class="card-body">
                                    ...
                                    >
                                        <div class="avatar-content">
                                            <i
                                                class="bi bi-diagram-3 font-medium"
                                            ></i>
                                        </div>
                                    </div>
                                    <h2 class="font-medium">
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="font-medium">
                                        <div v-if="totalInvestment.length > 0">
                                            <div
                                                v-for="investment in totalInvestment"
                                            >
                                                {{ investment.amount }}
                                                {{ investment.wallet }}
                                            </div>
                                    ...
                                    <p
                                        v-if="totalInvestment.length > 0"
                                        class="card-text"
                                    >
                                        {{ $t("Total Investment") }}
                                    </p>
                                    <p
                                        v-else="totalInvestment.length > 0"
                                        class="card-text"
                                    >
                        ...
                        <div class="card">
                            ...
                            >
                                ...
                                <Method
                                    v-if="
                                        ...
                                        mlmStore.planA.active_ref_commission !=
                                            null
                                    "
                                    title="Active Referral First Deposit Commission"
                                    icon="award"
                                    class="border-b dark:border-gray-600"
                                    :commission="
                                        mlmStore.planA.active_ref_commission
                                ...
                                />
                                <Method
                                    title="Bot Investment Commission"
                                    icon="robot"
                                    class="border-b dark:border-gray-600"
                                    :commission="mlmStore.planA.bot_commission"
                                    v-if="mlmStore.planA.bot_commission != null"
                                />
                                <Method
                                    title="Investment deposit Commission"
                                    icon="bar-chart"
                                    class="border-b dark:border-gray-600"
                                    :commission="
                                ...
                                <Method
                                    ...
                                    icon="layers"
                                    class="border-b dark:border-gray-600"
                                    :commission="mlmStore.planA.staking"
                                    v-if="mlmStore.planA.staking != null"
                                />
                                <Method
                                    title="Community Line Commission"
                                    icon="layers"
                                    :commission="
                    ...
                    <div class="card card-transaction">
                        ...
                        <div style="overflow-y: auto; max-height: 460px">
                            ...
                            >
                                <div
                                    class="border-b dark:border-gray-600"
                                    v-for="(bvLog, index) in mlmStore.bvLogs"
                                    :key="index"
                                >
                                    <div
                                    ...
                                    >
                                        <div class="flex items-center">
                                            <span
                                                v-if="bvLog.type == 1"
                                                class="text-success bg-dark mr-2 rounded px-2 py-1 shadow"
                                                ><i
                                                    style="
            ...
            <div class="card">
                <div class="card-body border-primary text-center">
                    ...
                    <div class="annual-plan my-2">
                        <div class="plan-price flex justify-center">
                            <sup
                                class="d-block font-medium-1 text-primary mt-2 font-medium"
                                >{{ plat.mlm.membership_deposit_currency }}</sup
                            >
                            <span
                                class="pricing-basic-value text-primary display-3 lh-1 font-medium"
                                >{{
                                    mlmStore.planB != null &&
        ...
        <form class="deposite-form" @submit.prevent="deposit('wallet')">
            <Modal
                ...
                @close="closeModal('depositWallet')"
            >
                <template #header>
                    <div class="flex items-center text-lg">
                    ...
                    for (
                        ...
                        if (
                            this.totalInvestment.filter(
                                (investment) =>
                                    investment.wallet == walletSymbol
                            ).length == 0
                        )
                        ...
                        if (!item.profit) {
                            if (
                                ...
                                this.dailyIncome.filter(
                                    (investment) =>
                                        investment.wallet == walletSymbol
                                )[0].amount += item.amount * percentage;
                        }
                    }
                }
