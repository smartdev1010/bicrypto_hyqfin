<template>
    <div>
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="profile-image-wrapper">
                            <div class="profile-image">
                                <div class="avatar">
                                    ...
                                    " :key="user.profile_photo_path" alt="avatar" />
                                </div>
                            </div>
                        </div>
                        <h3>{{ user.firstname }}</h3>
                        <div>
                            <span class="badge badge-light-success profile-badge">
                                {{ $t("Verified Trader") }}
                            </span>
                            <template v-if="plat.mlm.type == 'binary'">
                                <span v-if="planA.rank == 0" class="badge badge-light-primary profile-badge">{{ $t("No
                                                                    Business Rank") }}</span>
                                <span v-else class="badge badge-light-primary profile-badge">{{ $t("Business Rank") }}
                                    {{ planA.rank }}</span>
                            </template>
                            <template v-else-if="plat.mlm.type == 'unilevel'">
                                <span v-if="
                                    mlm.membership != 1 ||
                                    mlm.membership != 2
                                " class="badge badge-light-primary profile-badge">{{ $t("No VIP Privilege")
}}</span>
                                <span v-else class="badge badge-light-primary profile-badge">{{ $t("VIP Rank") }}
                                    {{ mlm.membership_rank }}</span>
                            </template>
                        </div>
                        <div class="mt-1" v-if="bvWithdrawable != null" :key="bvWithdrawable">
                            <div class="d-flex justify-content-between">
                                <small>0 BV</small>
                                <small>{{ plat.mlm.min_withdraw }} BV</small>
                            </div>
                            <div id="myRangeColor" class="progress" v-if="plat.mlm.min_withdraw != null">
                                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                                    :aria-valuenow="bvWithdrawable" aria-valuemin="0" :aria-valuemax="plat.mlm.min_withdraw"
                                    :style="'width:' + bvWithdrawable + '%'"></div>
                            </div>
                            <small class="text-warning">{{
                                $t("Progress To Unlock Withdrawal")
                            }}</small><br />
                            <div v-if="bvWithdrawable >= plat.mlm.min_withdraw" :key="bvWithdrawable">
                                <template v-if="plat.mlm.membership_status == 1">
                                    <button class="btn w-100 btn-success mt-2" data-bs-toggle="modal"
                                        data-bs-target="#withdraw">
                                        {{ $t("Withdraw") }}
                                    </button>
                                </template>
                                <template v-else>
                                    <button type="button" class="btn btn-success mt-1" :disabled="loading"
                                        @click="Withdraw()">
                                        {{ $t("Withdraw") }}
                                    </button>
                                </template>
                ...
                <Refer :pathname="pathname" :user="user" :reward="
                ...
                <div class="card" v-if="plat.mlm.type == 'binary'">
                    ...
                    <div class="card-body">
                        <div class="row g-1">
                            <span v-for="(ref, index) in ref_by" :key="index" class="col me-1 badge bg-warning">{{
                ...
                <div class="row match-height">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="row g-2" :key="bvWithdrawable">
                            ...
                            <div v-if="plat.mlm.commission_type == 'direct'" class="col-xl-6 col-lg-6">
                                <div class="card text-center">
                                    <div class="card-body">
                            ...
                            <div v-else-if="plat.mlm.commission_type == 'daily'" class="col-xl-6 col-lg-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div class="avatar bg-light-warning p-50 mb-1">
                                            <div class="avatar-content">
                            ...
                            <div class="col">
                                <div class="card card-transaction">
                                    ...
                                    <div class="card-body" style="
                                                ...
                                                max-height: 280px;
                                            ">
                                        <div class="transaction-item" v-if="
                                            planA.deposit_commission != null
                                        ">
                                            <div class="d-flex">
                                                <div class="avatar bg-light-primary rounded float-start">
                                                    <div class="avatar-content">
                                                        <span class="text-dark font-medium-5"><i
                                        ...
                                        <div class="transaction-item" v-if="planA.bot_commission != null">
                                            <div class="d-flex">
                                                <div class="avatar bg-light-primary rounded float-start">
                                                    <div class="avatar-content">
                                                        <span class="text-dark font-medium-5"><i
                                        ...
                                        <div class="transaction-item" v-if="planA.ico_commission != null">
                                            <div class="d-flex">
                                                <div class="avatar bg-light-primary rounded float-start">
                                                    <div class="avatar-content">
                                                        <span class="text-dark font-medium-5"><i
                                        ...
                                        <div class="transaction-item" v-if="planA.staking != null">
                                            <div class="d-flex">
                                                <div class="avatar bg-light-primary rounded float-start">
                                                    <div class="avatar-content">
                                                        <span class="text-dark font-medium-5"><i
                                            ...
                                            <div class="fw-bolder">
                                                <span class="badge bg-dark">{{ planA.staking }} %</span>
                                            </div>
                                        </div>
                                        <div class="transaction-item" v-if="
                                            plat.mlm
                                        ...
                                        ">
                                            ...
                                            <div class="fw-bolder">
                                                <span class="badge bg-dark">1.00 %</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="card card-transaction">
                            ...
                            <div class="card-body" style="overflow-y: auto; max-height: 460px">
                                <template v-if="bvLogs != null && bvLogs.length > 0">
                                    <div v-for="(bvLog, index) in bvLogs" :key="index" class="transaction-item">
                                        <div class="d-flex">
                                            <div class="avatar bg-light-primary rounded float-start">
                                                <div class="avatar-content">
                                                    <span v-if="bvLog.type == 1" class="text-success font-medium-5"><i
                                                            class="bi bi-cash"></i></span>
                                                    <span v-else-if="
                                                        bvLog.type == 2
                                                    " class="text-success font-medium-5"><i
                                                            class="bi bi-node-plus"></i></span>
                                                    <span v-if="bvLog.type == 3" class="text-success font-medium-5"><i
                                                            class="bi bi-award"></i></span>
                                                    <span v-if="bvLog.type == 4" class="text-success font-medium-5"><i
                                                            class="bi bi-currency-exchange"></i></span>
                                                    <span v-if="bvLog.type == 5" class="text-success font-medium-5"><i
                                                            class="bi bi-robot"></i></span>
                                                    <span v-if="bvLog.type == 6" class="text-success font-medium-5"><i
                                                            class="bi bi-coin"></i></span>
                                                    <span v-if="bvLog.type == 7" class="text-success font-medium-5"><i
                                                            class="bi bi-bar-chart"></i></span>
                                                    <span v-if="bvLog.type == 8" class="text-success font-medium-5"><i
                                                            class="bi bi-bar-chart"></i></span>
                                                    <span v-if="bvLog.type == 9" class="text-success font-medium-5"><i
                                                            class="bi bi-layers"></i></span>
                                                    <span v-if="bvLog.type == 10" class="text-success font-medium-5"><i
                                                            class="bi bi-person-lines-fill"></i></span>
                                                    <span v-if="bvLog.type == 11" class="text-success font-medium-5"><i
                                                            class="bi bi-download"></i></span>
                                                    <span v-if="bvLog.type == 12" class="text-success font-medium-5"><i
                                ...
                                <template v-else>
                                    <div class="text-muted text-center py-5" colspan="100%">
    ...
    D7.username
                        ...
                        <div id="pricing-plan">
                            ...
                            <div class="row pricing-card">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="card basic-pricing border text-center shadow-none" v-if="
                                        mlm.membership == 1 ||
                                        mlm.membership == 2
                                    ">
                                        <div class="card-body">
                                            <img src="/images/illustration/Pot1.svg" class="mb-2 mt-5" alt="svg img" />
                                            <h3>
                                                VIP {{ mlm.membership_rank }}
                                            </h3>
                                            <div class="annual-plan my-2">
                                                <div class="d-flex justify-content-center plan-price">
                                                    <sup class="d-block font-medium-1 fw-bold text-primary mt-2">{{
                                                        plat.mlm
                                                    ...
                                                    <sub class="pricing-duration text-body font-medium-1 fw-bold mt-3">{{
                                                        $t("Deposited")
                                                    }}</sub>
                                                </div>
                                            </div>
                                            ...
                                            <button class="btn w-100 btn-outline-success mt-2">
                                                {{ $t("Your current Rank") }}
                                            </button>
                                        </div>
                                    </div>
                                    <div class="card basic-pricing border text-center shadow-none" v-else>
                                        <div class="card-body">
                                            <img src="/images/illustration/Pot1.svg" class="mb-2 mt-5" alt="svg img" />
                                    ...
                                    <div class="card standard-pricing border-primary text-center shadow-none">
                                        <div class="card-body">
                                            <div class="pricing-badge text-end">
                                                <span class="badge rounded-pill badge-light-primary">{{ $t("Next Rank")
                                                }}</span>
                                            </div>
                                            <img src="/images/illustration/Pot2.svg" class="mb-1" alt="svg img" />
                                            ...
                                            <ul class="list-group list-group-circle text-start fw-bold">
                                                ...
                                                <li class="list-group-item" v-if="bv_total != null" :class="
                                                    bv_total -
                                                        planB.bv_required >
                                                        0
                                                        ? 'text-success'
                                            ...
                                            <button class="btn w-100 btn-primary mt-2" data-bs-toggle="modal"
        ...
        <div class="modal fade" tabindex="-1" id="deposit" aria-labelledby="VIP Rank" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button v-if="ext.eco == 1 && canDirect == true" :key="canDirect" type="submit"
                            class="btn btn-sm btn-warning" data-bs-target="#depositEco" data-bs-toggle="modal" @click="
                                fetchWallet(
                        ...
                        <button type="submit" class="btn btn-sm btn-success" data-bs-target="#depositWallet"
        ...
        <div class="modal fade" tabindex="-1" id="depositEco" aria-labelledby="VIP Rank" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                    ...
                    <form class="deposite-form" @submit.prevent="deposit('eco')">
                        <div class="modal-body">
                            <div :key="walCur" class="mb-1">
                                ...
                                <form v-if="walCur == null" @submit.prevent="
                                    createWallet(
                                        plat.mlm
                                            .membership_deposit_currency,
                                        plat.mlm
                                ...
                                <div v-else class="input-group">
                                    <input type="number" class="form-control text-dark border-0" :value="walCur"
                                        :key="walCur" readonly aria-label="Amount (to the nearest dollar)" />
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" id="amount" :min="plan0.deposits_required"
        ...
        <div class="modal fade" tabindex="-1" id="depositWallet" aria-labelledby="VIP Rank" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                    ...
                    <form class="deposite-form" @submit.prevent="deposit('wallet')">
                        <div class="modal-body">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" id="hash" v-model="hash"
        ...
        <div class="modal fade" tabindex="-1" id="withdraw" aria-labelledby="Withdraw" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                    ...
                    <form class="withdraw-form" @submit.prevent="membership_withdraw()">
                        <div class="modal-body">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" id="wallet_address" v-model="wallet_address"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm text-white btn-success" :disabled="loading">
                                {{ $t("Withdraw") }}
                            </button>
                        </div>
                    </form>
