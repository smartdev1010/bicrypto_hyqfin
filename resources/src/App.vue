            ...
            <div class="py-3 px-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center lg:order-2">
                        <a
                            v-if="
                                membershipStore.memberships.filter(
        ...
        >
            ...
            >
                ...
                >
                    <div
                        id="sidebarOverflow"
                        class="flex flex-1 flex-col overflow-x-hidden pt-5 pb-4"
                        style="max-height: calc(88vh)"
                        :class="
                            !sidebarCollapsed ||
                            (sidebarCollapsed && sidebarHover) ||
                            sidebarMobile
                    ...
                    >
                        <div
                            class="flex-1 space-y-1 divide-y divide-gray-200 px-3 dark:divide-gray-700"
                        >
                            <ul
                                id="sidebar-ul"
            ...
            >
                ...
                <div class="flex items-center justify-center space-x-3">
                    ...
                    >
                        <span class="sr-only">Open user menu</span>
                        <i
                            class="flag-icon mr-2 h-3.5 w-3.5 rounded-full"
                            :class="'flag-icon-' + locales[$i18n.locale].icon"
                        ></i>
                        <svg
            ...
            >
                <ul class="py-1" role="none">
                    <li v-for="(locale, key, index) in locales" :key="index">
                        <a
                            class="block py-1 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                            role="menuitem"
