<template>
    <div ref="container" class="tabs-wrap" @click.stop="hideDropdown">
        <div v-if="!inline" class="tabs-toggle" @click.stop="toggleDropdown">
...
export default {
    ...
    methods: {
        ...
        activateTab(index) {
            this.index =
                typeof index === "number" ? parseInt(index) : this.index;
