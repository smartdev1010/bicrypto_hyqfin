        ...
        <section class="page-topbar">
            <div class="container">
                <div class="flex-row flex-middle flex-space">
                    <!-- control search -->
                    <Search v-model="searchStr" class="light mr-1"></Search>

                    <!-- control heading -->
                    <div
                        class="flex-1 text-clip text-big text-center mr-1 if-medium"
                    >
                        Trading Bot
                    </div>
                ...
                <div class="card tablelist-wrap">
                    ...
                    <div class="tablelist-header">
                        <div class="flex-row flex-middle flex-stretch">
                            <div class="tablelist-20 text-clip mr-1">
                                <span
                                    class="clickable"
                                    @click="
                                        $sorter.sortOrder(
                            ...
                            <div class="tablelist-20 text-nowrap mr-1">
                                <span
                                    class="clickable"
                                    @click="
                                        $sorter.sortOrder(
                            ...
                            <div class="tablelist-20 text-nowrap text-end mr-1">
                                <span
                                    class="clickable"
                                    @click="
                                        $sorter.sortOrder(
                    ...
                    <!-- list items -->
                    <div v-if="balancesList.length" class="tablelist-content">
                        <div
                        ...
                        >
                            <div
                                class="tablelist-20 text-clip text-bright mr-1 if-medium"
                            >
                                {{ t.name }}
                            </div>
                            <div
                                class="tablelist-20 text-nowrap text-bright mr-1"
                            >
                                <router-link
                                    v-tooltip
                            ...
                            <div
                                class="tablelist-20 text-nowrap text-primary text-end text-monospace mr-1"
                            >
                                {{ t.total | toFixed }}
                            </div>
                            <div
                                class="tablelist-20 text-nowrap text-bright text-end text-monospace mr-1"
                            >
                                {{ t.free | toFixed }}
                            </div>
                            <div
            ...
            <div class="container">
                <div class="card p-1">
                    <div class="flex-row flex-space">
                        <div class="text-nowrap text-bright mr-1">
                            <span class="icon-chart-line iconLeft text-nowrap"
                                >Trade Bot</span
                            >
                        </div>
                        <div class="text-nowrap mr-1 if-medium">
                        ...
                        <div class="text-nowrap mr-1 if-small">
                    ...
                    <div class="flex-row flex-middle flex-srtetch">
                        ...
                        <div class="flex-1 text-clip mr-1">
                    ...
                    <div class="bot-form pt-1" :class="{ visible: formShow }">
                        ...
                        >
                            <div class="form-input text-nowrap">
                                <span class="mr-1 text-primary">Currency</span>
                                <SelectMenu
                            ...
                            <div class="form-input text-nowrap">
                                <span class="mr-1 text-primary">Only use</span>
                                <input
                            ...
                            <div class="form-input text-nowrap">
                                <span class="mr-1 text-primary">Stop loss</span>
                                <input
                            ...
                            <div class="form-input text-nowrap">
                                <span class="mr-1 text-primary">Limit</span>
                                <SelectMenu
                            ...
                            >
                                <span class="mr-1 text-primary">Execution</span>
                                <SelectMenu
                ...
                <div class="card p-1">
                    ...
                    >
                        ...
                        >
                            ...
                            <div v-if="tradesList.length" class="flex-list">
                                <div class="flex-header flex-middle flex-space">
                                    <div
                                        class="iconWidth text-nowrap mr-1 if-medium"
                                    ></div>
                                    <div class="flex-10 text-nowrap mr-1">
                                        <span
                                            class="clickable"
                                            @click="
                                                $sorter.sortOrder(
                                    ...
                                    <div
                                        class="flex-10 text-nowrap text-info mr-1"
                                    >
                                        Buy Price
                                    </div>
                                    <div
                        ...
                        >
                            ...
                            <div v-if="ordersList.length" class="flex-list">
                                <div class="flex-header flex-middle flex-space">
                                    <div
                                        class="iconWidth text-nowrap mr-1 if-medium"
                                    >
                                    ...
                                    <div
                                        class="flex-10 text-nowrap text-info mr-1 if-medium"
                                    >
                                        Fee
                                    </div>
                                    <div
                                ...
                                >
                                    ...
                                    <div
                                        class="flex-10 text-warning text-nowrap mr-1"
                                    >
                                        <span
                                            :class="{
                                                'text-danger':
                                    ...
                                    <div
                                        class="flex-10 text-nowrap mr-1 if-medium"
                                    >
                                        <span class="text-info">{{
                                            o.feeAsset
                                                ? o.feeAsset + " Total"
                        ...
                        >
                            ...
                            <div v-if="sessionsList.length" class="flex-list">
                                <div class="flex-header flex-middle flex-space">
                                    <div class="flex-10 text-nowrap mr-1">
                                        <span
                                            class="clickable"
