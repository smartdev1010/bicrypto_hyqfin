<template>
    <div class="card">
        <div class="card-body text-center">
            <i class="bi bi-gift text-warning mb-2 rounded-full px-2 py-1 text-2xl shadow"></i>
            <h5 class="card-title">{{ $t("Refer & Earn") }}</h5>
            <p class="mb-3 text-lg font-light text-gray-500 dark:text-gray-400 md:text-xl">
                {{
        ...
        <Modal v-if="isShowModal" size="4xl" @close="closeModal()">
            ...
            <template #body>
                <div class="px-sm-4 mx-5 mb-10 text-center">
                    <p class="mb-10 text-xl font-light text-gray-500 dark:text-gray-400 md:text-xl">
                        {{
                            $t(
                    ...
                    <div class="grid grid-cols-3 gap-5">
                            ...
                            <div class="mb-1 flex justify-center">
                                <div class="rounded-full px-3 py-2 shadow-lg">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="text-warning h-12 w-12">
                        ...
                        <div class="card p-5 shadow">
                            <div class="mb-1 flex justify-center">
                                <div class="rounded-full px-3 px-3 py-2 py-2 shadow-lg">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="text-info h-12 w-12">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="card p-5 shadow">
                            <div class="mb-1 flex justify-center">
                                <div class="rounded-full px-3 px-3 py-2 py-2 shadow-lg">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="text-success h-12 w-12">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="px-sm-5 mx-5">
                    ...
                    <form v-if="userStore.user != null" class="row g-1" onsubmit="return false">
                        <div class="lg:col-span-8">
                            ...
                            <div class="relative mb-2">
                                <input id="referralURL"
                                    ...
                                    " readonly />
                                <button id="copyBoard" type="submit"
                        ...
                        <div class="flex items-end lg:col-span-4">
                            <div class="social-btns">
                                <a :href="
                                    ...
                                    '/register/' +
                                    userStore.user.username
                                " type="button" class="btn btn-icon btn-facebook mr-5 text-2xl">
                                ...
                                <a :href="
                                    ...
                                    '/register/' +
                                    userStore.user.username
                                " type="button" class="btn btn-icon btn-twitter mr-5 text-2xl">
                                ...
                                <a :href="
                                    ...
                                    '/register/' +
                                    userStore.user.username
                                " type="button" class="btn btn-icon btn-linkedin mr-5 text-2xl">
                                ...
                                <a :href="
                                    ...
                                    '/register/' +
                                    userStore.user.username
                                " type="button" class="btn btn-icon btn-pinterest text-2xl">
