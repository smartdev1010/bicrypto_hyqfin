        ...
        <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
          ...
          <div class="row">
            <div class="mb-1 col-md-6">
              ...
              <input type="text" name="firstname" id="firstname"
                ...
                aria-describedby="register-firstname" tabindex="5" autofocus value="{{ old('firstname') }}" />
              @error('firstname')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
            ...
            <div class="mb-1 col-md-6">
              ...
              <input type="text" name="lastname" id="lastname"
                ...
                aria-describedby="register-lastname" tabindex="6" autofocus value="{{ old('lastname') }}" />
              @error('lastname')
              <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
              </span>
            ...
            <div class="mb-1 col-md-6">
              ...
              <div class="input-group">
                ...
                <input type="tel" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror"
                  placeholder="000-000-0000" aria-describedby="register-phone" tabindex="7" autofocus
                  value="{{ old('phone') }}" />
              </div>
              @error('phone')
              <span class="invalid-feedback" role="alert">
          ...
          <div class="row">
            <div class="col-12 my-1">
              ...
              <input type="text" class="form-control" id="multiStepsreferenceBy" name="multiStepsreferBy"
                placeholder="johndoe" aria-describedby="referenceBy" tabindex="8" autofocus
          ...
          <div class="mb-1">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="terms" name="terms" tabindex="9" />
