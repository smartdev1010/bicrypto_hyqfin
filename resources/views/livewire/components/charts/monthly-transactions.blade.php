<div class="card col-span-2 sm:col-span-2 md:col-span-1">
    ...
    <div class="mt-4 grid grid-cols-2 gap-3 px-4 sm:mt-5 sm:grid-cols-4 sm:gap-5 sm:px-5 lg:mt-6">
        <div class="rounded-lg bg-slate-100 p-4 dark:bg-gray-600">
            ...
            <p class="mt-1 text-xs text-slate-800 dark:text-gray-200">{{ $tooltip[0] }}</p>
        </div>
        <div class="rounded-lg bg-slate-100 p-4 dark:bg-gray-600">
            ...
            <p class="mt-1 text-xs text-slate-800 dark:text-gray-200">{{ $tooltip[1] }}</p>
        </div>
        <div class="rounded-lg bg-slate-100 p-4 dark:bg-gray-600">
            <div class="flex justify-between">
                <p class="text-xl font-semibold text-slate-700 dark:text-gray-100">
            ...
            <p class="mt-1 text-xs text-slate-800 dark:text-gray-200">{{ $tooltip[2] }}</p>
        </div>
        <div class="rounded-lg bg-slate-100 p-4 dark:bg-gray-600">
            <div class="flex justify-between">
                <p class="text-xl font-semibold text-slate-700 dark:text-gray-100">
            ...
            <p class="mt-1 text-xs text-slate-800 dark:text-gray-200">{{ $tooltip[3] }}</p>
        </div>
    </div>
