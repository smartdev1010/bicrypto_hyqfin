                                ...
                                <td>
                                    @can('tag_show')
                                        <a class="btn btn-sm btn-primary"
                                            href="{{ route('admin.knowledge.tags.show', $tag->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('tag_edit')
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.knowledge.tags.edit', $tag->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('tag_delete')
                                        <form action="{{ route('admin.knowledge.tags.destroy', $tag->id) }}" method="POST"
