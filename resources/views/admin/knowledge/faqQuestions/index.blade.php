                                ...
                                <td>
                                    @can('faq_question_show')
                                        <a class="btn btn-sm btn-primary"
                                            href="{{ route('admin.knowledge.faq-questions.show', $faqQuestion->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('faq_question_edit')
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.knowledge.faq-questions.edit', $faqQuestion->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('faq_question_delete')
                                        <form action="{{ route('admin.knowledge.faq-questions.destroy', $faqQuestion->id) }}"
