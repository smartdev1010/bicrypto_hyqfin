                                ...
                                <td>
                                    @can('category_show')
                                        <a class="btn btn-sm btn-primary"
                                            href="{{ route('admin.knowledge.categories.show', $category->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('category_edit')
                                        <a class="btn btn-sm btn-info"
                                            href="{{ route('admin.knowledge.categories.edit', $category->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('category_delete')
                                        <form action="{{ route('admin.knowledge.categories.destroy', $category->id) }}"
