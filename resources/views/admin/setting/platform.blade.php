                ...
                <div id="myTabContent">
                    <div class="space-y-3 px-3" id="system" aria-labelledby="system-tab" role="tabpanel">
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Service Worker') }}</span>
                            </div>
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->kyc->kyc_status }}" class="sr-only peer"
                                        ...
                                        id="kyc_status" @if ($platform->kyc->kyc_status == 1) checked @endif>
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->system->maintenance }}"
                                        class="sr-only peer" data-on="{{ __('Active') }}" data-off="{{ __('Inactive') }}"
                                        name="maintenance" id="maintenance"
                                        @if ($platform->system->maintenance == 1) checked @endif>
                                    <div class="toggle peer"
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->system->phone }}" class="sr-only peer"
                                        ...
                                        id="phone" @if ($platform->system->phone == 1) checked @endif>
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->frontend->frontend_status }}"
                                        ...
                                        data-off="{{ __('Inactive') }}" name="frontend_status" id="frontend_status"
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    ...
                                    <div class="toggle peer"
                                        onclick="$('#preloader').val($('#preloader').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Frontend Preloader') }}</span>
                            </div>
                            <small class="text-warning">
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    ...
                                    <div class="toggle peer"
                                        onclick="$('#auth_design').val($('#auth_design').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Auth Pages Design') }}</span>
                            </div>
                            <small class="text-warning">
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center justify-between">
                                ...
                                <select
                                    ...
                                    <option value="" @if (!isset($platform->dashboard->default_page) || $platform->dashboard->default_page == null || $platform->dashboard->default_page == '') selected @endif
                                        disabled="">
                                        {{ __('Choose an option') }}
                                    </option>
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    ...
                                    <div class="toggle peer"
                                        onclick="$('#trading_cards').val($('#trading_cards').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Trading Dynamic Cards') }}</span>
                            </div>
                            <small
                        ...
                        {{-- <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    ...
                                    <div class="toggle peer"
                                        onclick="$('#pair_prices').val($('#pair_prices').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Trading Page Pair Prices') }}</span>
                            </div>
                            <small
                            ...
                            <div class="tab-content col-span-3" id="myTabContent2">
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <select id="mlm_type" name="mlm_type"
                                                class="max-w-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="binary"
                                                    {{ $platform->mlm->type == 'binary' ? 'selected' : '' }}>
                                                    {{ __('Binary') }}</option>
                                                <option value="unilevel"
                                                    {{ $platform->mlm->type == 'unilevel' ? 'selected' : '' }}>
                                                    {{ __('Unilevel') }}</option>
                                            </select>
                                        </div>
                                        <small
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <select id="mlm_commission_type" name="mlm_commission_type"
                                                class="max-w-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="direct"
                                                    {{ $platform->mlm->commission_type == 'direct' ? 'selected' : '' }}>
                                                    {{ __('Direct') }}</option>
                                                <option value="daily"
                                                    {{ $platform->mlm->commission_type == 'daily' ? 'selected' : '' }}>
                                                    {{ __('Daily') }}</option>
                                            </select>
                                        </div>
                                        <small
                                ...
                                <div class="space-y-3 px-3 mb-1" id="mlm_membership" aria-labelledby="mlm_membership-tab"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->membership_status }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_status" id="membership_status"
                                                    @if ($platform->mlm->membership_status == 1) checked @endif>
                                                <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->membership_can_earn }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_can_earn" id="membership_can_earn"
                                                    @if ($platform->mlm->membership_can_earn == 1) checked @endif>
                                                <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="{{ $platform->mlm->membership_custom_deposit }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_custom_deposit" id="membership_custom_deposit"
                                                    @if ($platform->mlm->membership_custom_deposit == 1) checked @endif>
                                                <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="{{ $platform->mlm->membership_custom_withdraw }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_custom_withdraw" id="membership_custom_withdraw"
                                                    @if ($platform->mlm->membership_custom_withdraw == 1) checked @endif>
                                                <div class="toggle peer"
                                ...
                                <div class="space-y-3 px-3 mb-1" id="mlm_community_line"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="{{ $platform->mlm->community_line_status }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="community_line_status" id="community_line_status"
                                                    @if ($platform->mlm->community_line_status == 1) checked @endif>
                                                <div class="toggle peer"
                                ...
                                <div class="space-y-3 px-3 mb-1" id="mlm_earning_methods"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->deposits }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_deposits" id="mlm_deposits"
                                                    @if ($platform->mlm->deposits == 1) checked @endif>
                                                <div class="toggle peer"
                                    ...
                                    @if ($platform->mlm->type == 'binary')
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox" value="{{ $platform->mlm->first_deposit }}"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox"
                                                        value="{{ $platform->mlm->active_first_deposit }}"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->trades }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->bot_investment }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->ico_purchase }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->forex_deposit }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="{{ $platform->mlm->forex_investment }}"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                    ...
                                    @if ($ext[6] == 1)
                                        <div class="shadow rounded p-1">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox" value="{{ $platform->mlm->staking }}"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline2_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline2_status" id="unilevel_upline2_status"
                                                            @if ($platform->mlm->unilevel_upline2_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline3_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline3_status" id="unilevel_upline3_status"
                                                            @if ($platform->mlm->unilevel_upline3_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline4_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline4_status" id="unilevel_upline4_status"
                                                            @if ($platform->mlm->unilevel_upline4_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline5_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline5_status" id="unilevel_upline5_status"
                                                            @if ($platform->mlm->unilevel_upline5_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline6_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline6_status" id="unilevel_upline6_status"
                                                            @if ($platform->mlm->unilevel_upline6_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline7_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline7_status" id="unilevel_upline7_status"
                                                            @if ($platform->mlm->unilevel_upline7_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline8_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline8_status" id="unilevel_upline8_status"
                                                            @if ($platform->mlm->unilevel_upline8_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline8_status').val($('#unilevel_upline8_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('8nd Upline') }}</span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning">{{ __('Eighth Upline Commission Percentage') }}</small>
                                        </div>
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline9_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline9_status" id="unilevel_upline9_status"
                                                            @if ($platform->mlm->unilevel_upline9_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline9_status').val($('#unilevel_upline9_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('9nd Upline') }}</span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning">{{ __('Ninth Upline Commission Percentage') }}</small>
                                        </div>
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="{{ $platform->mlm->unilevel_upline10_status }}"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline10_status" id="unilevel_upline10_status"
                                                            @if ($platform->mlm->unilevel_upline10_status == 1) checked @endif>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline10_status').val($('#unilevel_upline10_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('10nd Upline') }}</span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning">{{ __('Tenth Upline Commission Percentage') }}</small>
                                        </div>
                                    </div>
                                @endif
                            </div>
                    ...
                    {{-- <div class="space-y-3 px-3" id="mobile" aria-labelledby="mobile-tab" role="tabpanel">
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    ...
                                    <div class="toggle peer"
                                        onclick="$('#mobile_market_info').val($('#mobile_market_info').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Market Info Card In Phones') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->mobile->trades }}"
                                        class="sr-only peer" data-on="Cover" data-off="Minimal" name="mobile_trades"
                                        id="mobile_trades" @if ($platform->mobile->trades == 1) checked @endif>
                                    <div class="toggle peer"
                                        onclick="$('#mobile_trades').val($('#mobile_trades').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Trades Card In Phones') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->mobile->charting }}"
                                        class="sr-only peer" data-on="Cover" data-off="Minimal" name="mobile_charting"
                                        id="mobile_charting" @if ($platform->mobile->charting == 1) checked @endif>
                                    <div class="toggle peer"
                                        onclick="$('#mobile_charting').val($('#mobile_charting').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Charting Card In Phones') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="{{ $platform->mobile->orders }}"
                                        class="sr-only peer" data-on="Cover" data-off="Minimal" name="mobile_orders"
                                        id="mobile_orders" @if ($platform->mobile->orders == 1) checked @endif>
                                    <div class="toggle peer"
                                        onclick="$('#mobile_orders').val($('#mobile_orders').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Orders Card In Phones') }}</span>
                            </div>
                        </div>
