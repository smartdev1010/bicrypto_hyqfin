        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="margin" name="margin" aria-label="Rank Withdraw Margin"
              aria-describedby="margin" value="{{ $rank->margin }}">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="ref_commission" name="ref_commission"
              aria-label="ref Commission" aria-describedby="ref_commission" value="{{ $rank->ref_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="active_ref_commission" name="active_ref_commission"
              ...
              value="{{ $rank->active_ref_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="trade_commission" name="trade_commission"
              aria-label="trade Commission" aria-describedby="trade_commission" value="{{ $rank->trade_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="bot_commission" name="bot_commission"
              aria-label="bot Commission" aria-describedby="bot_commission" value="{{ $rank->bot_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="ico_commission" name="ico_commission"
              aria-label="ico Commission" aria-describedby="ico_commission" value="{{ $rank->ico_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="forex_commission" name="forex_commission"
              aria-label="ico Commission" aria-describedby="forex_commission" value="{{ $rank->forex_commission }}">
            <span class="input-group-text">%</span>
          </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="bv_required" name="bv_required" aria-label="ico Commission"
              aria-describedby="bv_required" value="{{ $rank->bv_required }}">
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="input-group mb-1">
            <input type="text" class="form-control" id="direct_required" name="direct_required"
              aria-label="ico Commission" aria-describedby="direct_required" value="{{ $rank->direct_required }}">
          </div>
        </div>
        @endif
      </div>
      <div class="row">
        <div class="col-xl-3 col-md-6">
          ...
          <input type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle"
            data-on="{{ __('locale.Active') }}" data-off="{{ __('locale.Disabled') }}" data-width="100%" name="status"
            @if ($rank->status == 1) checked @endif>
        </div>
      </div>
    </div>
