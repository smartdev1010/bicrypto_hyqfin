            ...
            <tr>
              ...
              <td data-label="{{ __('locale.Action') }}">
                ...
                <button type="button" class="btn btn-icon btn-info btn-sm" data-bs-toggle="modal"
                  data-bs-target="#deposit_statusUpdate" data-id="{{ $transaction->id }}"
                ...
                @else
                <button type="button" class="btn btn-icon btn-info btn-sm" data-bs-toggle="modal"
                  data-bs-target="#withdraw_statusUpdate" data-id="{{ $transaction->id }}"
                  data-user_id="{{ $transaction->user_id }}" data-wallet_address="{{ $transaction->wallet_address }}"
      ...
      <div class="modal-body flex-grow-1">
        <div>
          ...
          <div class="input-group">
            <input type="number" class="form-control" required="" id="amount" name="amount" placeholder="Amount">
          </div>
    ...
    <form class="add-new-record modal-content pt-0" action="{{ route('admin.mlm.transaction.statusUpdate') }}"
      ...
      <div class="modal-body flex-grow-1">
        <div>
          ...
          <div class="input-group">
            <input type="text" class="form-control" required="" id="wallet_address" name="wallet_address"
        ...
        <div>
          ...
          <div class="input-group">
            <input type="text" class="form-control" required="" id="amount" name="amount" placeholder="Amount" readonly>
          </div>
