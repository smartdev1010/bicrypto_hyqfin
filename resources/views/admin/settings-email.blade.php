...
@section('content')
                    ...
                    <div class="content-area card">
                        <div class="card-innr">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">{{ __('Email Templates') }}<br></h3>
                                <ul class="text-end">
                                    <a data-bs-toggle="modal" data-bs-target="#mailSetting" class="btn btn-primary">
                                        <i class="bi bi-gear"></i><span> {{ __('Email Settings') }}</span>
                                    </a>
                                </ul>
                            </div>
                            <div class="card-text">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">{{ __('Edit') }} {{ $template->name }}
                                                            {{ __('Template') }}
                                                        </h5>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.settings.email.template.update') }}"
                                                            ...
                                                            <div class="input-item input-with-label">
                                                                <label for="name" class="input-item-label">
                                                                    {{ __('Name') }}</label>
                                                            ...
                                                            <div class="input-item input-with-label">
                                                                <label for="subject"
                                                                    class="input-item-label">{{ __('Template Subject') }}</label>
                                                                <div class="input-wrap">
                                                            ...
                                                            <div class="input-item input-with-label">
                                                                <label for="greeting"
                                                                    class="input-item-label">{{ __('Template Greeting') }}</label>
                                                                <div class="input-wrap">
                                                            ...
                                                            <div class="input-item  input-with-label">
                                                                <label for="message"
                                                                    class="input-item-label">{{ __('Template Content') }}</label>
                                                                <div class="input-wrap">
                                                            ...
                                                            @if (str_contains($template->slug, 'admin'))
                                                                <div class="input-item input-with-label">
                                                                    <span
                                                                        class="input-item-label">{{ __('Send Notification to Admin') }}</span>
                                                                    <div class="input-wrap">
                                                            ...
                                                            <div class="input-item input-with-label">
                                                                <span
                                                                    class="input-item-label">{{ __('Email Footer') }}</span>
                                                                <div class="input-wrap">
                                                                    <input type="checkbox" class="input-switch"
                                                                ...
                                                                <span
                                                                    class="text-info">{{ __('You can use these shortcut') }}:
                                                                    [[site_name]], [[site_email]], [[user_name]]
                                                                    @if ($template->slug == 'send-user-email')
                                                                        , [[message]]
                                                                    @endif
                                                                    @if (Str::startsWith($template->slug, 'order-'))
                                                                ...
                                                                <span
                                                                    class="text-danger">{{ __('Do not use Markdown character,It may broke email style') }}.</span>
                                                            </div>
    ...
    <div id="mailSetting" class="modal fade text-start" tabindex="-1" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Update Mailing Setting') }}</h5>
                ...
                <form action="{{ route('admin.settings.email.update') }}" autocomplete="false" method="POST"
                    ...
                    <div class="modal-body">
                        @csrf
                        <h5 class="text-primary">{{ __('Choose Email Driver') }} </h5>
                        <div class="row">
                            <div class="col-4">
                                <div class="input-item input-with-label">
                                    ...
                                    <label for="smtp_uchk">{{ __('Send Mail') }}</label>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-item input-with-label">
                            ...
                            <div class="col-4">
                                <div class="input-item input-with-label">
                                    ...
                                    <small class="text-success">*{{ __('Recommended') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="smtp-box">
                            <div class="col-12 col-md-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('SMTP HOST') }}</label>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('SMTP Port') }}</label>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('SMTP Secure') }}</label>
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('SMTP Username') }}</label>
                            ...
                            <div class="col-sm-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('SMTP Password') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('Email From Address') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    <label class="input-item-label">{{ __('Email From Name') }}</label>
                            ...
                            <div class="row">
                                <div class=" input-item input-with-label">
                                    <label class="input-item-label">{{ __('Email Global Footer') }}</label>
                            ...
                            <div class="col-md-8">
                                <div class="input-item input-with-label">
                                    <label for="emails"
                                        class="input-item-label">{{ __('Enter External Emails') }}</label>
                                    <div class="input-wrap">
