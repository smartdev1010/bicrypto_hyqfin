                ...
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="system-tab" data-tabs-target="#system"
                            ...
                            aria-selected="true"><?php echo e(__('System')); ?></button>
                    ...
                    <li class="mr-2" role="presentation">
                        <button
                            ...
                            aria-controls="dashboard" aria-selected="false"><?php echo e(__('Dashboard')); ?></button>
                    ...
                    <li class="mr-2" role="presentation">
                        <button
                            ...
                            aria-controls="trading" aria-selected="false"><?php echo e(__('Trading')); ?></button>
                    ...
                    <?php if($ext[6] == 1): ?>
                        <li class="mr-2" role="presentation">
                            <button
                                ...
                                aria-controls="staking" aria-selected="false"><?php echo e(__('Staking')); ?></button>
                        </li>
                    <?php endif; ?>
                    <?php if($ext[10] == 1): ?>
                        <li class="mr-2" role="presentation">
                ...
                <div id="myTabContent">
                    <div class="space-y-3 px-3" id="system" aria-labelledby="system-tab" role="tabpanel">
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->kyc->kyc_status); ?>" class="sr-only peer"
                                        data-on="<?php echo e(__('Active')); ?>" data-off="<?php echo e(__('Inactive')); ?>" name="kyc_status"
                                        id="kyc_status" <?php if($platform->kyc->kyc_status == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer"
                                        onclick="$('#kyc_status').val($('#kyc_status').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('KYC')); ?></span>
                            </div>
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->system->maintenance); ?>"
                                        class="sr-only peer" data-on="<?php echo e(__('Active')); ?>" data-off="<?php echo e(__('Inactive')); ?>"
                                        name="maintenance" id="maintenance"
                                        <?php if($platform->system->maintenance == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer"
                                        onclick="$('#maintenance').val($('#maintenance').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Maintenance')); ?></span>
                            </div>
                            <small class="text-warning">
                            ...
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->system->phone); ?>" class="sr-only peer"
                                        data-on="<?php echo e(__('Active')); ?>" data-off="<?php echo e(__('Inactive')); ?>" name="phone"
                                        id="phone" <?php if($platform->system->phone == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer" onclick="$('#phone').val($('#phone').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Phone Number')); ?></span>
                            </div>
                            <small class="text-warning">
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->frontend->frontend_status); ?>"
                                        class="sr-only peer" data-on="<?php echo e(__('Active')); ?>"
                                        data-off="<?php echo e(__('Inactive')); ?>" name="frontend_status" id="frontend_status"
                                        <?php if($platform->frontend->frontend_status == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer"
                                        onclick="$('#frontend_status').val($('#frontend_status').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Frontend')); ?></span>
                            </div>
                            <small class="text-warning">
                    ...
                    <div class="space-y-3 px-3" id="dashboard" aria-labelledby="dashboard-tab" role="tabpanel">
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            ...
                            <small
                                class="text-warning"><?php echo e(__('Set first pair to show when you click start trading')); ?></small>
                        </div>
                    </div>
                    <div class="space-y-3 px-3" id="trading" aria-labelledby="trading-tab" role="tabpanel">
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->trading->binary_status); ?>"
                                        class="sr-only peer" data-on="Cover" data-off="Minimal" name="binary_status"
                                        id="binary_status" <?php if($platform->trading->binary_status == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer"
                                        onclick="$('#binary_status').val($('#binary_status').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Binary Trading')); ?></span>
                            </div>
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center mb-2">
                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                    <input type="checkbox" value="<?php echo e($platform->trading->practice); ?>"
                                        class="sr-only peer" data-on="Cover" data-off="Minimal" name="practice"
                                        id="practice" <?php if($platform->trading->practice == 1): ?> checked <?php endif; ?>>
                                    <div class="toggle peer"
                                        onclick="$('#practice').val($('#practice').val() != 1 ? 1 : 0)">
                                    </div>
                                </label>
                                <span
                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Practice Trading Only')); ?></span>
                            </div>
                            <small
                        ...
                        <div class="border rounded dark:border-gray-600 shadow p-2">
                            <div class="flex items-center justify-between">
                                ...
                                <select id="deposit_fees_method" name="deposit_fees_method"
                                    ...
                                    <option value="added"
                                        <?php echo e($platform->wallet->deposit_fees_method == 'added' ? 'selected' : ''); ?>>
                                        <?php echo e(__('Added')); ?></option>
                                    <option value="subtracted"
                                        <?php echo e($platform->wallet->deposit_fees_method == 'subtracted' ? 'selected' : ''); ?>>
                            ...
                            <ul class="nav nav-tabs nav-fill border-primary shadow col-span-1 ml-3" role="tablist"
                                ...
                                <li
                                    ...
                                    <a id="mlm_general-tab" data-tabs-target="#mlm_general" aria-controls="mlm_general"
                                        role="tab" aria-selected="true"><?php echo e(__('General Settings')); ?></a>
                                </li>
                                <li
                                    class="flex justify-start items-center p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <div class="tab-content col-span-3" id="myTabContent2">
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <select id="mlm_type" name="mlm_type"
                                                class="max-w-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="binary"
                                                    <?php echo e($platform->mlm->type == 'binary' ? 'selected' : ''); ?>>
                                                    <?php echo e(__('Binary')); ?></option>
                                                <option value="unilevel"
                                                    <?php echo e($platform->mlm->type == 'unilevel' ? 'selected' : ''); ?>>
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <select id="mlm_commission_type" name="mlm_commission_type"
                                                class="max-w-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="direct"
                                                    <?php echo e($platform->mlm->commission_type == 'direct' ? 'selected' : ''); ?>>
                                                    <?php echo e(__('Direct')); ?></option>
                                                <option value="daily"
                                                    <?php echo e($platform->mlm->commission_type == 'daily' ? 'selected' : ''); ?>>
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="mlm_min_withdraw"
                                                    value="<?php echo e($platform->mlm->min_withdraw ?? 100); ?>">
                                                <span>BV</span>
                                            </div>
                                        </div>
                                        <small
                                            class="text-warning"><?php echo e(__('Minimum business value earned to unlock withdrawal button')); ?></small>
                                    </div>
                                </div>
                                <div class="space-y-3 px-3 mb-1" id="mlm_membership" aria-labelledby="mlm_membership-tab"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->membership_status); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_status" id="membership_status"
                                                    <?php if($platform->mlm->membership_status == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#membership_status').val($('#membership_status').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Membership')); ?></span>
                                        </div>
                                        <small
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->membership_can_earn); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_can_earn" id="membership_can_earn"
                                                    <?php if($platform->mlm->membership_can_earn == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#membership_can_earn').val($('#membership_can_earn').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Only Members Can Earn')); ?></span>
                                        </div>
                                        <small
                                            class="text-warning"><?php echo e(__('Only clients with active membership can earn BV or reward his uplines')); ?>
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        ...
                                        <small
                                            class="text-warning"><?php echo e(__('Duration of no BV earning until membership is cancelled')); ?>
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="<?php echo e($platform->mlm->membership_custom_deposit); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_custom_deposit" id="membership_custom_deposit"
                                                    <?php if($platform->mlm->membership_custom_deposit == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="<?php echo e($platform->mlm->membership_custom_withdraw); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="membership_custom_withdraw" id="membership_custom_withdraw"
                                                    <?php if($platform->mlm->membership_custom_withdraw == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                        ...
                                        <small
                                            class="text-warning"><?php echo e(__('Show withdraw card ability to set client own wallet to withdraw to')); ?>
                                    ...
                                    <div class="shadow rounded p-1">
                                        <label class="form-label"
                                            for="membership_terms"><?php echo e(__('Membership Upgrade Terms')); ?></label>
                                ...
                                <div class="space-y-3 px-3 mb-1" id="mlm_community_line"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox"
                                                    value="<?php echo e($platform->mlm->community_line_status); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="community_line_status" id="community_line_status"
                                                    <?php if($platform->mlm->community_line_status == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#community_line_status').val($('#community_line_status').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Community Line')); ?></span>
                                        </div>
                                        <small
                                            class="text-warning"><?php echo e(__('When client deposit, latest clients in the community will get 1% as BV')); ?>
                                    ...
                                    <div class="shadow rounded p-1">
                                        ...
                                        <small
                                            class="text-warning"><?php echo e(__('Number of clients that will recieve the 1% BV in the community line')); ?>
                                ...
                                <div class="space-y-3 px-3 mb-1" id="mlm_earning_methods"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->deposits); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_deposits" id="mlm_deposits"
                                                    <?php if($platform->mlm->deposits == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#mlm_deposits').val($('#mlm_deposits').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('BV from Deposits')); ?></span>
                                        </div>
                                        <small
                                    ...
                                    <?php if($platform->mlm->type == 'binary'): ?>
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox" value="<?php echo e($platform->mlm->first_deposit); ?>"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                        name="mlm_first_deposit" id="mlm_first_deposit"
                                                        <?php if($platform->mlm->first_deposit == 1): ?> checked <?php endif; ?>>
                                                    <div class="toggle peer"
                                                        onclick="$('#mlm_first_deposit').val($('#mlm_first_deposit').val() != 1 ? 1 : 0)">
                                                    </div>
                                                </label>
                                                <span
                                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('BV from First Deposits')); ?></span>
                                            </div>
                                            <small
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox"
                                                        value="<?php echo e($platform->mlm->active_first_deposit); ?>"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                        name="mlm_active_first_deposit" id="mlm_active_first_deposit"
                                                        <?php if($platform->mlm->active_first_deposit == 1): ?> checked <?php endif; ?>>
                                                    <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->trades); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_trades" id="mlm_trades"
                                                    <?php if($platform->mlm->trades == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#mlm_trades').val($('#mlm_trades').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('BV from Trades')); ?></span>
                                        </div>
                                        <small
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->bot_investment); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_bot_investment" id="mlm_bot_investment"
                                                    <?php if($platform->mlm->bot_investment == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->ico_purchase); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_ico_purchase" id="mlm_ico_purchase"
                                                    <?php if($platform->mlm->ico_purchase == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#mlm_ico_purchase').val($('#mlm_ico_purchase').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->forex_deposit); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_forex_deposit" id="mlm_forex_deposit"
                                                    <?php if($platform->mlm->forex_deposit == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                                    onclick="$('#mlm_forex_deposit').val($('#mlm_forex_deposit').val() != 1 ? 1 : 0)">
                                                </div>
                                            </label>
                                            <span
                                                class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('BV from Forex Deposits')); ?></span>
                                        </div>
                                        <small
                                    ...
                                    <div class="border rounded dark:border-gray-600 shadow p-2">
                                        <div class="flex items-center mb-2">
                                            <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                <input type="checkbox" value="<?php echo e($platform->mlm->forex_investment); ?>"
                                                    class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                    name="mlm_forex_investment" id="mlm_forex_investment"
                                                    <?php if($platform->mlm->forex_investment == 1): ?> checked <?php endif; ?>>
                                                <div class="toggle peer"
                                    ...
                                    <?php if($ext[6] == 1): ?>
                                        <div class="shadow rounded p-1">
                                            <div class="flex items-center mb-2">
                                                <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                    <input type="checkbox" value="<?php echo e($platform->mlm->staking); ?>"
                                                        class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                        name="mlm_staking" id="mlm_staking"
                                                        <?php if($platform->mlm->staking == 1): ?> checked <?php endif; ?>>
                                                    <div class="toggle peer"
                                                        onclick="$('#mlm_staking').val($('#mlm_staking').val() != 1 ? 1 : 0)">
                                                    </div>
                                                </label>
                                                <span
                                                    class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('BV from Staking')); ?></span>
                                            </div>
                                            <small
                                ...
                                <?php if($platform->mlm->type == 'unilevel'): ?>
                                    <div class="space-y-3 px-3 mb-1" id="mlm_rewards" aria-labelledby="mlm_rewards-tab"
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Direct Referrer Commission Percentage')); ?></small>
                                        </div>
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline2_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline2_status" id="unilevel_upline2_status"
                                                            <?php if($platform->mlm->unilevel_upline2_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline2_status').val($('#unilevel_upline2_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('2nd Upline')); ?></span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Second Upline Commission Percentage')); ?></small>
                                        </div>
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline3_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline3_status" id="unilevel_upline3_status"
                                                            <?php if($platform->mlm->unilevel_upline3_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline3_status').val($('#unilevel_upline3_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('3nd Upline')); ?></span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Third Upline Commission Percentage')); ?></small>
                                        </div>
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline4_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline4_status" id="unilevel_upline4_status"
                                                            <?php if($platform->mlm->unilevel_upline4_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline4_status').val($('#unilevel_upline4_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('4nd Upline')); ?></span>
                                                </div>
                                                <div>
                                                    <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Fourth Upline Commission Percentage')); ?></small>
                                        </div>
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline5_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline5_status" id="unilevel_upline5_status"
                                                            <?php if($platform->mlm->unilevel_upline5_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline5_status').val($('#unilevel_upline5_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('5nd Upline')); ?></span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Fifth Upline Commission Percentage')); ?></small>
                                        </div>
                                        ...
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline6_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline6_status" id="unilevel_upline6_status"
                                                            <?php if($platform->mlm->unilevel_upline6_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline6_status').val($('#unilevel_upline6_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('6nd Upline')); ?></span>
                                                </div>
                                                <div class="input-group">
                                            ...
                                            <small
                                                class="text-warning"><?php echo e(__('Sixth Upline Commission Percentage')); ?></small>
                                        </div>
                                        <div class="border rounded dark:border-gray-600 shadow p-2">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center mb-2">
                                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                                        <input type="checkbox"
                                                            value="<?php echo e($platform->mlm->unilevel_upline7_status); ?>"
                                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                                            name="unilevel_upline7_status" id="unilevel_upline7_status"
                                                            <?php if($platform->mlm->unilevel_upline7_status == 1): ?> checked <?php endif; ?>>
                                                        <div class="toggle peer"
                                                            onclick="$('#unilevel_upline7_status').val($('#unilevel_upline7_status').val() != 1 ? 1 : 0)">
                                                        </div>
                                                    </label>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('7nd Upline')); ?></span>
                                                </div>
                                                <div class="input-group">
                    ...
                    <?php if($ext[6] == 1): ?>
                        <div class="space-y-3 px-3" id="staking" aria-labelledby="staking-tab" role="tabpanel">
                            <div class="border rounded dark:border-gray-600 shadow p-2">
                                <div class="flex items-center mb-2">
                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                        <input type="checkbox" value="<?php echo e($platform->staking->cancel_stake); ?>"
                                            class="sr-only peer" data-on="Cover" data-off="Minimal" name="cancel_stake"
                                            id="cancel_stake" <?php if($platform->staking->cancel_stake == 1): ?> checked <?php endif; ?>>
                                        <div class="toggle peer"
                                            onclick="$('#cancel_stake').val($('#cancel_stake').val() != 1 ? 1 : 0)">
                                        </div>
                                    </label>
                                    <span
                                        class="text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo e(__('Cancel Claim Option')); ?></span>
                                </div>
                                <small
                    ...
                    <?php if($ext[10] == 1): ?>
                        <div class="space-y-3 px-3" id="eco" aria-labelledby="eco-tab" role="tabpanel">
                            <div class="border rounded dark:border-gray-600 shadow p-2">
                                <div class="flex items-center mb-2">
                                    <label class="inline-flex relative items-center cursor-pointer mr-3">
                                        <input type="checkbox" value="<?php echo e($platform->eco->ecosystem_trading_only); ?>"
                                            class="sr-only peer" data-on="Cover" data-off="Minimal"
                                            name="ecosystem_trading_only" id="ecosystem_trading_only"
                                            <?php if($platform->eco->ecosystem_trading_only == 1): ?> checked <?php endif; ?>>
                                        <div class="toggle peer"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hyqfin/public_html/resources/views/admin/setting/platform.blade.php ENDPATH**/ ?>