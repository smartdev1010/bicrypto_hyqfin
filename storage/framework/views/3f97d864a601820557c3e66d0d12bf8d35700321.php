...
} elseif ($_instance->childHasBeenRendered('nyuSOfK')) {
    $componentId = $_instance->getRenderedChildComponentId('nyuSOfK');
    $componentTag = $_instance->getRenderedChildComponentTagName('nyuSOfK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nyuSOfK');
} else {
    $response = \Livewire\Livewire::mount('ext.forex.forex-investment-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('nyuSOfK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
