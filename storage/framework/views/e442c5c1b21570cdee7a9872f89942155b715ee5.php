    ...
    <form action="<?php echo e(route('admin.withdraw.method.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-5">
                ...
                <div class="card-body">
                    <div class="grid xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  xl:grid-cols-4 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="currency" value="<?php echo e(old('currency')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white placeholder-red-500">
                        </div>
                        <div>
                            <label for="delay"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?php echo e(__('Processing Time')); ?></label>
                            <input type="text" name="delay" value="<?php echo e(old('delay')); ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white placeholder-red-500">
                        </div>
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    ...
                                    id="rate" placeholder="0" name="rate" value="<?php echo e(old('rate')); ?>">
                    ...
                    <div class="card-body space-y-3">
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-red-500"
                                    placeholder="0" name="min_limit" value="<?php echo e(old('min_limit')); ?>">
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-red-500"
                                    placeholder="0" name="max_limit" value="<?php echo e(old('max_limit')); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body space-y-3">
                        <div>
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-red-500"
                                    placeholder="0" name="fixed_charge" value="<?php echo e(old('fixed_charge')); ?>">
                            </div>
                        </div>
                        <div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex">
                                ...
                                <input type="number"
                                    class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder-red-500"
                                    pplaceholder="0" name="percent_charge" value="<?php echo e(old('percent_charge')); ?>">
            ...
            <div class="card">
                ...
                <textarea id="instruction" name="instruction"><?php echo e(old('instruction')); ?></textarea>
            </div>
            <div class="card border-dark">
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-success"><?php echo app('translator')->get('Save Method'); ?></button>
                </div>
            </div>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hyqfin/public_html/resources/views/admin/withdraw/create.blade.php ENDPATH**/ ?>