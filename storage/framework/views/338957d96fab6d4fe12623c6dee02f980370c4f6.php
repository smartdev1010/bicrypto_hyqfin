...
} elseif ($_instance->childHasBeenRendered('QwHplit')) {
    $componentId = $_instance->getRenderedChildComponentId('QwHplit');
    $componentTag = $_instance->getRenderedChildComponentTagName('QwHplit');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QwHplit');
} else {
    $response = \Livewire\Livewire::mount('ext.forex.forex-investment-log-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('QwHplit', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
