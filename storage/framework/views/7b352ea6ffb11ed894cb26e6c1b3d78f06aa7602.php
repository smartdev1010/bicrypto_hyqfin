...
} elseif ($_instance->childHasBeenRendered('cAItH4W')) {
    $componentId = $_instance->getRenderedChildComponentId('cAItH4W');
    $componentTag = $_instance->getRenderedChildComponentTagName('cAItH4W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cAItH4W');
} else {
    $response = \Livewire\Livewire::mount('report.wallet-transactions', []);
    $html = $response->html();
    $_instance->logRenderedChild('cAItH4W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
