        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center text-light">
                    <p><?php echo e(__("locale.page you are looking for doesn't exit or an other error occured")); ?> <br>
                        <?php echo e(__('or temporarily unavailable.')); ?></p>
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-primary"><?php echo e(__('Go to Home')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/hyqfin/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>