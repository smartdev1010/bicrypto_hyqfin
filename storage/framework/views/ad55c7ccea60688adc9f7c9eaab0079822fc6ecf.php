...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('Fy4NLw3')) {
    $componentId = $_instance->getRenderedChildComponentId('Fy4NLw3');
    $componentTag = $_instance->getRenderedChildComponentTagName('Fy4NLw3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Fy4NLw3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('Fy4NLw3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('C5Z2nKf')) {
    $componentId = $_instance->getRenderedChildComponentId('C5Z2nKf');
    $componentTag = $_instance->getRenderedChildComponentTagName('C5Z2nKf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C5Z2nKf');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('C5Z2nKf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('gwR605s')) {
    $componentId = $_instance->getRenderedChildComponentId('gwR605s');
    $componentTag = $_instance->getRenderedChildComponentTagName('gwR605s');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gwR605s');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('gwR605s', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('vzC8fw0')) {
    $componentId = $_instance->getRenderedChildComponentId('vzC8fw0');
    $componentTag = $_instance->getRenderedChildComponentTagName('vzC8fw0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vzC8fw0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('vzC8fw0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('2a21s82')) {
    $componentId = $_instance->getRenderedChildComponentId('2a21s82');
    $componentTag = $_instance->getRenderedChildComponentTagName('2a21s82');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2a21s82');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('2a21s82', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('3pm9Dt2')) {
    $componentId = $_instance->getRenderedChildComponentId('3pm9Dt2');
    $componentTag = $_instance->getRenderedChildComponentTagName('3pm9Dt2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3pm9Dt2');
} else {
    $response = \Livewire\Livewire::mount('components.charts.monthly-transactions', ['element' => 'deposits','route' => 'admin.users.all','title' => 'Deposits','tooltip' => ['Total', 'Fees', 'Completed', 'Pending'],'colors' => ['#9061F9', '#E74694', '#0E9F6E', '#E3A008'],'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" /></svg>']);
    $html = $response->html();
    $_instance->logRenderedChild('3pm9Dt2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('yorRH0g')) {
    $componentId = $_instance->getRenderedChildComponentId('yorRH0g');
    $componentTag = $_instance->getRenderedChildComponentTagName('yorRH0g');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yorRH0g');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('yorRH0g', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hyqfin/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>