...
} elseif ($_instance->childHasBeenRendered('lg1xkGP')) {
    $componentId = $_instance->getRenderedChildComponentId('lg1xkGP');
    $componentTag = $_instance->getRenderedChildComponentTagName('lg1xkGP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lg1xkGP');
} else {
    $response = \Livewire\Livewire::mount('ext.bot.bot-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('lg1xkGP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
