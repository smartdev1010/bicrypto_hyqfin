...
} elseif ($_instance->childHasBeenRendered('ddjax9c')) {
    $componentId = $_instance->getRenderedChildComponentId('ddjax9c');
    $componentTag = $_instance->getRenderedChildComponentTagName('ddjax9c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ddjax9c');
} else {
    $response = \Livewire\Livewire::mount('ext.bot.bot-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('ddjax9c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
