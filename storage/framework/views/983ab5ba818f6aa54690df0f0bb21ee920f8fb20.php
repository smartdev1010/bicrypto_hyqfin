...
} elseif ($_instance->childHasBeenRendered('diSonLd')) {
    $componentId = $_instance->getRenderedChildComponentId('diSonLd');
    $componentTag = $_instance->getRenderedChildComponentTagName('diSonLd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('diSonLd');
} else {
    $response = \Livewire\Livewire::mount('ext.bot.bot-log-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('diSonLd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
