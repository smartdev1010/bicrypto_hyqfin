...
} elseif ($_instance->childHasBeenRendered('uiUAF1k')) {
    $componentId = $_instance->getRenderedChildComponentId('uiUAF1k');
    $componentTag = $_instance->getRenderedChildComponentTagName('uiUAF1k');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uiUAF1k');
} else {
    $response = \Livewire\Livewire::mount('wallets-table', ['user' => $user->id]);
    $html = $response->html();
    $_instance->logRenderedChild('uiUAF1k', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('3LWXVex')) {
    $componentId = $_instance->getRenderedChildComponentId('3LWXVex');
    $componentTag = $_instance->getRenderedChildComponentTagName('3LWXVex');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3LWXVex');
} else {
    $response = \Livewire\Livewire::mount('wallets-frozen-table', ['frozen' => count($frozen_wallet) > 0 ? 1 : 0]);
    $html = $response->html();
    $_instance->logRenderedChild('3LWXVex', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
