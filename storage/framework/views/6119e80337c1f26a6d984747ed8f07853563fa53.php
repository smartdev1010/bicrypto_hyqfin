...
} elseif ($_instance->childHasBeenRendered('708oKR1')) {
    $componentId = $_instance->getRenderedChildComponentId('708oKR1');
    $componentTag = $_instance->getRenderedChildComponentTagName('708oKR1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('708oKR1');
} else {
    $response = \Livewire\Livewire::mount('components.nav.profile', []);
    $html = $response->html();
    $_instance->logRenderedChild('708oKR1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
</html><?php /**PATH D:\dev\vscode\resources\views/layouts/user.blade.php ENDPATH**/ ?>