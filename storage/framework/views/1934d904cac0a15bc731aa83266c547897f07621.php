...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('w3b6Nvs')) {
    $componentId = $_instance->getRenderedChildComponentId('w3b6Nvs');
    $componentTag = $_instance->getRenderedChildComponentTagName('w3b6Nvs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w3b6Nvs');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('w3b6Nvs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('nXVBqHM')) {
    $componentId = $_instance->getRenderedChildComponentId('nXVBqHM');
    $componentTag = $_instance->getRenderedChildComponentTagName('nXVBqHM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nXVBqHM');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('nXVBqHM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('KD4K3hU')) {
    $componentId = $_instance->getRenderedChildComponentId('KD4K3hU');
    $componentTag = $_instance->getRenderedChildComponentTagName('KD4K3hU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KD4K3hU');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('KD4K3hU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('u67v2p0')) {
    $componentId = $_instance->getRenderedChildComponentId('u67v2p0');
    $componentTag = $_instance->getRenderedChildComponentTagName('u67v2p0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u67v2p0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('u67v2p0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('F6oyJMj')) {
    $componentId = $_instance->getRenderedChildComponentId('F6oyJMj');
    $componentTag = $_instance->getRenderedChildComponentTagName('F6oyJMj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F6oyJMj');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('F6oyJMj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('OSqP8hh')) {
    $componentId = $_instance->getRenderedChildComponentId('OSqP8hh');
    $componentTag = $_instance->getRenderedChildComponentTagName('OSqP8hh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OSqP8hh');
} else {
    $response = \Livewire\Livewire::mount('components.charts.monthly-transactions', ['element' => 'deposits','route' => 'admin.users.all','title' => 'Deposits','tooltip' => ['Total', 'Fees', 'Completed', 'Pending'],'colors' => ['#9061F9', '#E74694', '#0E9F6E', '#E3A008'],'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" /></svg>']);
    $html = $response->html();
    $_instance->logRenderedChild('OSqP8hh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('BRzQaU8')) {
    $componentId = $_instance->getRenderedChildComponentId('BRzQaU8');
    $componentTag = $_instance->getRenderedChildComponentTagName('BRzQaU8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BRzQaU8');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('BRzQaU8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
