...
Vvveb.Components.extend("_base", "widgets/video", {
    ...
    dragHtml: '<img src="' +
        Vvveb.baseUrl +
        'icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
        ...
        //if (property.key == "t")
        {
            switch (this.t) {
                ...
                case "h":
                    ...
                    newnode = $(
                        '<div data-component-video><video src="' +
                        this.url +
                        '" ' +
                        (this.autoplay ? " autoplay " : "") +
                        (this.controls ? " controls " : "") +
                        (this.loop ? " loop " : "") +
                        ' style="height: 100%; width: 100%;"></video></div>'
                    );
                    break;
            }
