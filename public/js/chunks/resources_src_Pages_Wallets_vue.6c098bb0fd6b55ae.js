...
/* harmony import */ var _components_wallets_WalletDetail_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/wallets/WalletDetail.vue */ "./resources/src/components/wallets/WalletDetail.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  // component list
  components: {
    WalletDetail: _components_wallets_WalletDetail_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  // component data
  data: function data() {
    return {
  ...
  methods: {
    ...
    fetchData: function fetchData() {
      ...
      this.$http.post("/user/fetch/wallets").then(function (response) {
        _this.user = response.data.user, _this.wallets = response.data.wallets, _this.api = response.data.api, _this.currencies = response.data.currencies;
      });
    },
