    ...
    public function update(Request $request)
    {
        ...
        if (getExt(3) == 1) {
            ...
            $platform['mlm']->settings = json_encode([
                ...
                'unilevel_upline11_percentage' => $request->unilevel_upline11_percentage,
                'unilevel_upline12_percentage' => $request->unilevel_upline12_percentage,
                ...
                'unilevel_upline11_status' => $request->unilevel_upline11_status ?? 0,
                'unilevel_upline12_status' => $request->unilevel_upline12_status ?? 0,
