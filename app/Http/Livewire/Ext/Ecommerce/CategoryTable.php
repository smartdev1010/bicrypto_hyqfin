    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Icon', "icon")
                ->collapseOnTablet()
                ->format(
                    fn ($value, $row, Column $column) => '<img src="' . getImage(imagePath()['ecommerce_category']['path'] . '/' . $row->icon, imagePath()['ecommerce_category']['size']) . '">'
                )
                ->html(),
            ...
            Column::make("Actions", "id")
                ->view('extensions.admin.ecommerce.actions'),
        ];
    }
